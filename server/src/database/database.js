...
/**
     ...
     */
function _executeSql_(conn, sqlStr, data) {
  return new Promise((resolve, reject) => {
    // 使用try...catch语句捕获未知错误
    try {
...
/**
     ...
     */
function _beginTransaction_(conn) {
  return new Promise((resolve, reject) => {
    try {
...
/**
     ...
     */
function _transactionExecuteSql_(conn, sqlStr, data) {
  return new Promise((resolve, reject) => {
    try {
      conn.query(sqlStr, data, (err, result) => {
        if (err) {
...
/**
     ...
     */
function _commitTransaction_(conn) {
  return new Promise((resolve, reject) => {
    try {
      conn.commit((err) => {
        if (err) {
...
/**
   ...
   */
function update(sqlStr, data) {
  return _getConn_().then((conn) => {
    return _executeSql_(conn, sqlStr, data)
  }).then((result) => {
    // 修改成功resolve(true)
    return new Promise((resolve, reject) => {
